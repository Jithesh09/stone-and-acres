      ...
      <div className="container">
        ...
        <div className="d-lg-none w-100">
          ...
          <div className="collapse navbar-collapse mt-2" id="mobileNav">
            <ul className="navbar-nav text-center">
              ...
              <li className="nav-item">
                <a className="nav-link custom-link" href="/varam-contact-us"
                onClick={(e) => handleNavClick(e, "contact", "/varam-contact-us")}>
                  Contact Us
                </a>
              </li>
            </ul>
        ...
        <div className="d-none d-lg-flex w-100 justify-content-between align-items-center">
          ...
          <div className="navbar-nav">
            ...
            <a className="nav-link custom-link" href="/varam-layout"
            onClick={(e) => handleNavClick(e, "layout", "/varam-layout")}>Layout</a>
            <a className="nav-link custom-link" href="/varam-gallery" onClick={(e) => handleNavClick(e, "gallery", "/varam-gallery")}>Gallery</a>
            <a className="nav-link custom-link" href="/varam-contact-us" onClick={(e) => handleNavClick(e, "contact", "/varam-contact-us")}>Contact Us</a>
          </div>
        </div>
      </div>
    </nav>
