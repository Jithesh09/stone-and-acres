  ...
  return (
    <section className="proximity-section" id="proximity">
      <div className="container">
        <div className="row">
          <div className="col-12 mb-4 text-center" data-aos="fade-right" data-aos-duration="1000">
        ...
        <div className="row px-lg-5">
          {/* Left Side Accordion */}
          <div className="col-md-6 px-lg-5" data-aos="fade-right" data-aos-duration="1000">
            <div className="accordion" id="proximityAccordion">
              ...
              <div className="accordion-item mt-0">
                <h2 className="accordion-header" id="headingOne">
                  <button 
                    className={`accordion-button ${activeAccordion === "worksites" ? "" : "collapsed"}`} 
                    type="button"
              ...
              <div className="accordion-item">
                <h2 className="accordion-header" id="headingTwo">
                  <button 
                    className={`accordion-button ${activeAccordion === "colleges" ? "" : "collapsed"}`} 
                    type="button"
              ...
              <div className="accordion-item">
                <h2 className="accordion-header" id="headingThree">
                  <button 
                    className={`accordion-button ${activeAccordion === "schools" ? "" : "collapsed"}`} 
                    type="button"
              ...
              <div className="accordion-item">
                <h2 className="accordion-header" id="headingFour">
                  <button 
                    className={`accordion-button ${activeAccordion === "entertainment" ? "" : "collapsed"}`} 
                    type="button"
              ...
              <div className="accordion-item">
                <h2 className="accordion-header" id="headingFive">
                  <button 
                    className={`accordion-button ${activeAccordion === "commute" ? "" : "collapsed"}`} 
                    type="button"
          ...
          >
            ...
            >
              <h5>Worksites</h5>
              <ul>
                <li><span>Oragadam SIPCOT Industrial Park </span> - 5 Mins</li>
                <li><span>Apollo Tyres</span> - 10 Mins</li>
                <li><span>Royal Enfield Factory</span> - 10 Mins</li>
                <li><span>Danfoss Industries</span> - 12 Mins</li>
                <li><span>Zoho</span> - 12 Mins</li>
                <li><span>Shriram IT Gateway </span> - 25 Mins</li>
                <li><span>Mahindra World City</span> - 30 Mins</li>
              </ul>
            </div>
            ...
            >
              <h5>Colleges</h5>
              <ul>
                <li><span>Hindustan Institute of Engineering Technology </span> - 3 Mins</li>
                <li><span>RRASE College of Engineering</span> - 4 Mins</li>
                <li><span>Dhaanish Ahmed College of Engineering </span> - 5 Mins</li>
                <li><span>PSP Medical College </span> - 10 Mins</li>
                <li><span>Crescent University</span> - 10 Mins</li>
                <li><span>SRM University</span> - 28 Mins</li>
            ...
            >
              <h5>Schools</h5>
              <ul>
                <li><span>Ravindra Bharathi Global School </span> - 3 Mins</li>
                <li><span>Alwin International Public School </span> - 10 Mins</li>
                <li><span>Shree Niketan Patasala </span> - 10 Mins</li>
                <li><span>Velammal Vidhyashram</span> - 13 Mins</li>
                <li><span>The Indian Public School</span> - 14 Mins</li>
                <li><span>Thriveni Academy Sr. Sec. School </span> - 15 Mins</li>
            ...
            >
              <h5>Entertainment</h5>
              <ul>
                <li><span>Hilarity Inn Hotel</span> - 2 Mins</li>
                <li><span>Mercure Hotel</span> - 10 Mins</li>
                <li><span>A2B Restaurant</span> - 10 Mins</li>
                <li><span>Thennaman Restaurant</span> - 10 Mins</li>
                <li><span>SH 48 Food Court</span> - 12 Mins</li>
                <li><span>Harsha Gardens (Banquet Hall)</span> - 13 Mins</li>
                <li><span>Vandalur Zoo</span> - 25 Mins</li>
                <li><span>Queensland</span> - 30 Mins</li>
              </ul>
            </div>
            ...
            >
              <h5>Commute</h5>
              <ul>
                <li><span>Tambaram Railway Station </span> - 10 Mins</li>
                <li><span>Padappai Flyover</span> - 8 Mins</li>
                <li><span>Kilambakkam Bus Terminus </span> - 12 Mins</li>
                <li><span>Chennai Airport </span> - 30 Mins</li>
              </ul>
              <h5>Proposed Upcoming Commute</h5>
              <ul>
                <li><span>Tambaram Railway Station </span> - 10 Mins</li>
                <li><span>Kilambakkam Electric Railway Station </span> - 8 Mins</li>
                <li><span>Kilambakkam Metro </span> - 12 Mins</li>
                <li><span>Parandur Airport </span> - 30 Mins</li>
              </ul>
            </div>
          </div>
        </div>
