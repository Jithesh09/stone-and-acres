        ...
        <div className="row align-items-center edge-row ">
          ...
          >
            ...
            <p className="edge-description-pon" data-aos="fade-up">
              This project spans 125 acres in the rapidly developing area of
              Chennai, providing excellent connectivity to SIPCOT IT Park, OMR
              Road, and Medavakkam. With well-planned infrastructure, lifestyle
              amenities, and a peaceful environment, these Plots in Ponmar are
              ideal for families and investors looking for comfort, convenience,
              and long-term growth in Chennai.
            </p>
