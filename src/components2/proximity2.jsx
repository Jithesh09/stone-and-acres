          ...
          <div className="row px-lg-5">
            ...
            >
              ...
              >
                ...
                <ul>
                  <li>
                    <span>15 mins from SIPCOT IT Park</span> - 15 mins
                  </li>
                  <li>
                    <span>OMR Road and Medavakkam </span> - 20 mins
                  </li>
                  {/* <li><span>Shree Niketan Patasala </span> - 10 Mins</li> */}
                  <li>
                    <span>Easy access to Tambaram, Sholinganallur, and Perumbakkam</span>
                  </li>
                  <li>
                    <span>Surrounded by top schools, hospitals, and IT hubs</span>
                  </li>
                  <li>
